...
public class ObjectFactory {
    ...
    private final static QName _Convert_QNAME = new QName("http://ws.enset.org/", "Convert");
    private final static QName _ConvertResponse_QNAME = new QName("http://ws.enset.org/", "ConvertResponse");
    private final static QName _Compte_QNAME = new QName("http://ws.enset.org/", "compte");
    private final static QName _Comptes_QNAME = new QName("http://ws.enset.org/", "comptes");
    private final static QName _ComptesResponse_QNAME = new QName("http://ws.enset.org/", "comptesResponse");
    private final static QName _GetCompte_QNAME = new QName("http://ws.enset.org/", "getCompte");
    private final static QName _GetCompteResponse_QNAME = new QName("http://ws.enset.org/", "getCompteResponse");
     ...
     */
    @XmlElementDecl(namespace = "http://ws.enset.org/", name = "comptes")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.enset.org/", name = "comptesResponse")
